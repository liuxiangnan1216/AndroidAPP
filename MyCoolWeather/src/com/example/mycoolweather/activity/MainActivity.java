...
public class MainActivity extends Activity {
	...
	private static final String TAG = "liuxiangnan******MainActivity";
	...
	private void queryCounties() {
	    Log.e(TAG, "***queryCounties**" + coolWeatherDB.loadCounties(selectedCity.getId()));
	    if (coolWeatherDB.loadCounties(selectedCity.getId()) == null) {
		return;
	    }
