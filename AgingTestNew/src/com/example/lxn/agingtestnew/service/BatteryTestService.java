...
import com.example.lxn.agingtestnew.utills.BatteryUtil;
import com.example.lxn.agingtestnew.utills.ShellUtils;
...
public class BatteryTestService extends Service {
    ...
    public static final String SERVICE_ALIVE_MARKER = "com.example.lxn.agingtestnew.service.BatteryTestService";
    private int MAX_LEVEL = 100;
    private int MIN_LEVEL = 70;
    private String CHANNEL_ID = "BatteryService_Notification";
    private String CHANNEL_NAME = "BatteryService";
    ...
    private Notification createNotification() {
        ...
        builder.setContentText("Battery Testing, Exiting the app will stop testing!!!");
