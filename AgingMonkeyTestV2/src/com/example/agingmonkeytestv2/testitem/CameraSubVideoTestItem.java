...
public class CameraSubVideoTestItem extends AbstractBaseTestItem {
    ...
    public CameraSubVideoTestItem(int resLayoutId) {
		super(resLayoutId);
    ...
    protected void initView(View view) {
        ...
        if (cameraInfo.facing == CameraInfo.CAMERA_FACING_BACK ) {
        	this.mFragment = CameraVideoFragment.newInstance(CameraInfo.CAMERA_FACING_FRONT);
